...
const areaIcons = ['document', 'briefcase', 'building', 'shield'];
    ...
    <main>
      ...
      <section className="areas" id="atuacao">
        <div className="sectionHead reveal">
          ...
          <h2>Um caminho jurídico<br />bem estruturado.</h2>
          <p>Cada demanda é conduzida com organização técnica, do primeiro contato à resolução.</p>
        </div>
      ...
      <section className="about" id="escritorio">
        ...
        <div className="aboutCopy reveal">
          ...
          <h2>Técnica a serviço<br />de cada decisão.</h2>
          <p>{site.about}</p>
          <ul>
            {site.values.map((v) => (
              <li key={v}><b>✓</b>{v}</li>
